(function () {
  ...
  var TypeError$d = global$z.TypeError; // `RequireObjectCoercible` abstract operation
  ...
  var TypeError$c = global$u.TypeError; // `Assert: IsCallable(argument) is true`
  ...
  var TypeError$b = global$t.TypeError; // `OrdinaryToPrimitive` abstract operation
  ...
  var global$s = global$B; // eslint-disable-next-line es/no-object-defineproperty -- safe

  var defineProperty$4 = Object.defineProperty;

  var setGlobal$3 = function (key, value) {
    try {
      defineProperty$4(global$s, key, {
        value: value,
        configurable: true,
        writable: true
      });
  ...
  var Object$3 = global$q.Object; // `ToObject` abstract operation
  ...
  var document$1 = global$n.document; // typeof document.createElement is 'object' in old IE
  ...
  var TypeError$9 = global$m.TypeError; // `Assert: Type(argument) is Object`
  ...
  var TypeError$8 = global$l.TypeError; // eslint-disable-next-line es/no-object-defineproperty -- safe
  ...
  */
  ...
  var Object$2 = global$g.Object; // ES3 wrong here
  ...
  var Array$2 = global$f.Array; // a part of `ArraySpeciesCreate` abstract operation
  ...
  var arraySpeciesConstructor$1 = function (originalArray) {
    ...
    if (isArray$4(originalArray)) {
      ...
      if (isConstructor$1(C) && (C === Array$2 || isArray$4(C.prototype))) C = undefined;else if (isObject$3(C)) {
        C = C[SPECIES$2];
  ...
  var functionApply = typeof Reflect == 'object' && Reflect.apply || (bind$1 ? call$7.bind(apply$5) : function () {
    return call$7.apply(apply$5, arguments);
  });
  ...
  var AsyncIterator = global$d.AsyncIterator;
  ...
  } else if (shared$1[USE_FUNCTION_CONSTRUCTOR] || global$d[USE_FUNCTION_CONSTRUCTOR]) {
    try {
  ...
  var asyncIteratorCreateProxy = function (nextHandler, IS_ITERATOR) {
      ...
      next: function next(arg) {
        ...
        return new Promise$1(function (resolve) {
          ...
          resolve(state.done ? {
            ...
            value: undefined
          } : anObject$c(call$6(nextHandler, state, Promise$1, args)));
        });
      },
    ...
    if (!IS_ITERATOR) {
      createNonEnumerableProperty$3(AsyncIteratorProxy.prototype, TO_STRING_TAG$3, 'Generator');
    }
  ...
  var AsyncIteratorProxy$1 = createAsyncIteratorProxy$1(function (Promise, args) {
    ...
    return new Promise(function (resolve, reject) {
      var loop = function () {
        try {
          Promise.resolve(anObject$b(apply$4(state.next, state.iterator, args))).then(function (step) {
            try {
  ...
  var NativeIterator = global$b.Iterator; // FF56- have non-standard global helper `Iterator`
  ...
  if (!hasOwn$4(IteratorPrototype$1, TO_STRING_TAG$2)) {
    createNonEnumerableProperty$2(IteratorPrototype$1, TO_STRING_TAG$2, 'Iterator');
  }
    ...
    IteratorProxy.prototype = redefineAll(create(IteratorPrototype), {
      ...
      'return': function (value) {
        ...
        return {
          ...
          value: $$return ? anObject$a(call$5($$return, iterator, value)).value : value
        };
      },
      'throw': function (value) {
        var state = getInternalState$1(this);
  ...
  var IteratorProxy$1 = createIteratorProxy$1(function (args) {
    ...
    while (true) {
      result = anObject$7(apply$3(next, iterator, args));
  ...
  var TypeError$5 = global$a.TypeError; // We can't use this feature detection in V8 since it causes
  // deoptimization and serious performance degradation
  ...
  var createMethod = function (TYPE) {
    ...
    return function (iterator, fn, target) {
      ...
      var next = aCallable$3(iterator.next);
      var index = 0;
      ...
      return new Promise(function (resolve, reject) {
        var closeIteration = function (method, argument) {
          try {
            ...
            if (returnMethod) {
              return Promise.resolve(call$3(returnMethod, iterator)).then(function () {
                method(argument);
              }, function (error) {
                reject(error);
              });
        ...
        var loop = function () {
          try {
            if (IS_TO_ARRAY && index > MAX_SAFE_INTEGER && MAPPING) {
              throw TypeError$4('The allowed number of iterations has been exceeded');
            }

            Promise.resolve(anObject$6(call$3(next, iterator))).then(function (step) {
              try {
  ...
  var getIteratorMethod$2 = function (it) {
    if (it != undefined) return getMethod(it, ITERATOR) || getMethod(it, '@@iterator') || Iterators[classof$2(it)];
  };
  ...
  var getIterator$1 = function (argument, usingIterator) {
    ...
    if (aCallable$2(iteratorMethod)) return anObject$5(call$2(iteratorMethod, argument));
  ...
  var selectNode = function selectNode(id) {
    var className = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'selected';
    return select("#".concat(id)).classed(className, true);
  };
  var clearSelections = function clearSelections() {
    var selector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '#nodes > g';
    var className = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'selected';
    return selectAll(selector).classed(className, false);
  };
  ...
  var tooltip = create$3('aside').attr('class', 'tooltip empty');
  ...
  var showTooltip = function showTooltip(entity) {
    ...
    var listKeyDataEntities = function listKeyDataEntities(list, heading) {
      ...
      return "<h2>".concat(heading, "</h2>\n    <ul class='tag-cloud'>\n      ").concat(list.map(function (x) {
        return "<li>".concat(nodePath(x, entity, 'name', ' :: '), "</li>");
      }).join(''), "\n    </ul>");
    };
  ...
  function radialTree(ecosystem) {
    ...
    var svg = create$3('svg'); // .attr('viewBox', [-width / 2, -height / 2, width, height]);
    ...
    svg.append('g').attr('id', 'nodes').selectAll('circle').data(nodes).join('g').attr('id', function (d) {
      ...
      var selectNet = function selectNet(n) {
